(function(){
  const K = {
    suppliers: "or_v114_suppliers",
    items: "or_v114_items",
    active: "or_v114_active",
    orders: "or_v114_orders",
    draft: "or_v114_draft",
    notes: "or_v114_notes"
  };
  ...
  (function(){ const d=new Date(); $("#headerDate").textContent=`יום ${days[d.getDay()]} · ${d.getDate()} ב${months[d.getMonth()]} ${d.getFullYear()}`; })();
